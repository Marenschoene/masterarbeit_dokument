...
Zu aussagekräftigeren Ergebnissen kommen \textcite[S. 1ff.]{combiningCbAndCFCostSensitiveApproach:2017}. Die Wissenschaftler implementierten ein hybrides, modellbasiertes Empfehlungssystem zur Stellensuche. Dabei kombinierten sie kollaboratives und inhaltsbasiertes Filtern. Zur Evaluation vergleichen die Forscher ihr System mit dem rein inhaltsbasierten Empfehlungsansatz. Hierbei teilten sie ihren vorhandenen Datensatz in Trainings- und Testdaten und stellten fest, dass der hybride Ansatz zu besseren Ergebnissen führte.
...
Trotz dieser Ergebnisse kritisieren \textcite[S. 1]{malinowski:2008}, dass ein hybrides Empfehlungssystem nicht ausreicht, um geeignete Mitarbeiter für Stellen zu empfehlen. Deren Einschätzung zu Folge ist die Entwicklung bilateraler Empfehlungssysteme notwendig.
