...
Gemäß \textcite[S. 675]{jannach:2:article} kann über die \ac{SVR} eine Aggregations-Funktion erlernt werden, die den Zusammenhang zwischen einer Gesamtbewertung und einzelnen Kriterien beschreibt. 
...
Hierzu zählen
\begin{itemize}
    \item Verfahren für das Finden Pareto-optimaler Lösungen (bspw. Skyline Queries \cite[S. 273ff.]{lee:inproceedings}),
    \item Aggregation mittels Linear-Kombination und Domänenwissen über Ordnung von Elementen (BSP!), sowie
    \item Verwendung multi-kriterieller Bewertungen als Filterkriterien für Empfehlungen (BSP!).
\end{itemize}
...
% HIER WEITERMACHEN: Beispiele für dei Punkte noch hinzufügen (Vgl. 1. Punkt)
