...
% Jede Kombination von Nutzer und Element kann einer Klasse $z \in Z=\{z_{1},...,z_{l}\}$ zugeordnet werden \cite[S. 51]{hofmann:inproceedings}.
...
% \end{equation}
% das mit aufnehmen ja/nein? wie ansätze erklären, die darauf basieren?
...
% Grundlage bildet SVD: diese besagt ...
