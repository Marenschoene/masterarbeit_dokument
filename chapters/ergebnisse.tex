...
Nachfolgend werden die Auswirkungen auf die beiden Kennzahlen im Detail betrachtet.

\subsection{Auswirkung auf die Zufriedenheit der Mitarbeitenden}
In Abbildung ... ist zu erkennen, dass es bei 18 der insgesamt 25 Fälle keine Änderung zwischen dem Anteil zufriedener Mitarbeitender unter Einsatz des unilateralen Algorithmus und dem Anteil zufriedener Mitarbeitender unter Anwendung des bilateralen Algorithmus gegeben hat.

In Abbildung \ref{fig:ergebnisse:abb9} ist der durchschnittliche Anteil an zufriedenen Mitarbeitenden an den unilateralen und an den bilateralen Rankings je Projekt dargestellt.
Daran ist zu erkennen, dass sample-und projektübergreifend durch Einsatz des bilateralen Algorithmus vermehrt Mitarbeitende empfohlen wurden, die eine hohe Zufriedenheit für die jeweiligen Projekte angaben.

\begin{figure}[H]
    \centering
	\includegraphics[width=0.9\textwidth]{gfx/verhaeltnis-z-durchschnitt-projekte.png}
...
\subsection{Auswirkung auf die erwartete Arbeitsleistung der Mitarbeitenden durch die Manager}
Ein ähnliches Muster wird bei Betrachtung der Auswirkung auf die zu erwartende Arbeitsleistung der Mitarbeitenden durch die Manager deutlich.
Die Anzahl an Fällen ohne Änderung zwischen dem Anteil an Mitarbeitenden mit zu erwartend hoher Arbeitsleistung durch Einsatz des unilateralen Algorithmus und dem Anteil an Mitarbeitenden mit zu erwartend hoher Arbeitsleistung unter Anwendung des bilateralen Algorithmus lag hier bei 19.
