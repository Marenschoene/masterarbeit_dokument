...
In Abbildung \ref{fig:ergebnisse:analyse:abb5} ist zu erkennen, dass ca. ein Drittel aller Mitarbeiter die durchschnittlich gesuchte Fähigkeit jeder Projektposition beherrschen (orange markiert und orange-blau schraffiert). Darüber hinaus ist zu beobachten, dass durchschnittlich 41 Prozent aller Mitarbeiter, welche eine gesuchte Fähigkeit beherrschen (orange markiert und organge-blau schraffiert), deren Anwendung nicht präferieren (orange markiert). Werden ausschließlich die Projektpositionen A bis D betrachtet, liegt der Anteil bei knapp über einem Drittel der Angestellten. Abschließend ist zu Abbildung \ref{fig:ergebnisse:analyse:abb5} festzustellen, dass die orange-blau schraffierten und blau markierten Anteile an Mitarbeitern im Durchschnitt gleich groß sind.
...
\begin{figure}[h]
	\centering
	\includegraphics[width=0.85\textwidth]{gfx/mitarbeiter-zufriedenheit-umfrage.png}
...
\begin{figure}[h]
	\centering
	\includegraphics[width=0.85\textwidth]{gfx/zufriedenheit-projekte.png}	
...
An der Umfrage unter den Projektmanagern haben N=7 Personen teilgenommen. Sechs der Teilnehmer sind im Bereich \JES tätig. Eine Person stammt aus einer anderen Abteilung, welche jedoch ähnliche Technologien bei der Projekttätigkeit einsetzt. Abbildung \ref{fig:ergebnisse:fallstudie:arbeitsleistung:abb1} zeigt, von den Vorschlägen welches Empfehlungsansatzes die Projektmanager eine höhere Arbeitsleistung erwarten.
...
An den Ergebnissen aus Abbildung \ref{fig:ergebnisse:fallstudie:arbeitsleistung:abb1} ist zu erkennen, dass die Projektmanager bei drei der fünf Projektpositionen von den vorgeschlagenen Mitarbeitern des bilateralen Empfehlungsansatzes eine höhere Arbeitsleistung erwarten. Für Projektposition A prognostiziert sogar kein einziger Projektmanager eine höhere Leistung von den unilateralen Empfehlungen. Auffällig ist außerdem, dass die Hälfte der Teilnehmer von den Vorschlägen des bilateralen Empfehlungssystems für Projektposition D eine viel höhere Arbeitsleistung erwartet. Bei den Vorschlägen für die Projektpositionen C und E bewerten die Projektmanager jedoch die Arbeitsleistungen des unilateralen Empfehlungsansatzes gegenüber der bilateralen Variante als höher.
