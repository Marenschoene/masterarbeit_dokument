...
\begin{figure}[h]
	...
	\subfloat[Projektposition A]{\includegraphics[width = 0.4\textwidth]{gfx/projekt-detail-a.png}}
	\subfloat[Projektposition B]{\includegraphics[width = 0.4\textwidth]{gfx/projekt-detail-b.png}}
...
\begin{figure}[h]
	...
	\subfloat[Projektposition C]{\includegraphics[width = 0.4\textwidth]{gfx/projekt-detail-c.png}}
	\subfloat[Projektposition D]{\includegraphics[width = 0.4\textwidth]{gfx/projekt-detail-d.png}}
...
\begin{figure}[h]
	...
	\subfloat[Projektposition E]{\includegraphics[width = 0.4\textwidth]{gfx/projekt-detail-e.png}}
	\subfloat[Legende]{\includegraphics[width = 0.4\textwidth]{gfx/projekt-detail-legende.png}}
...
\begin{figure}[h]
	...
	\subfloat[Projektposition A]{\includegraphics[width = 0.4\textwidth]{gfx/zufriedenheit-projekt-a.png}}
	\subfloat[Projektposition B]{\includegraphics[width = 0.4\textwidth]{gfx/zufriedenheit-projekt-b.png}}
	\newline
	\subfloat[Projektposition C]{\includegraphics[width = 0.4\textwidth]{gfx/zufriedenheit-projekt-c.png}}
	\subfloat[Projektposition D]{\includegraphics[width = 0.4\textwidth]{gfx/zufriedenheit-projekt-d.png}}
	\newline
	\subfloat[Projektposition E]{\includegraphics[width = 0.4\textwidth]{gfx/zufriedenheit-projekt-e.png}}
	\subfloat[Legende]{\includegraphics[width = 0.4\textwidth]{gfx/zufriedenheit-projekt-legende.png}}
