...
Der Parameter $\beta$ steht in Gleichung \ref{frml:empfehlungssysteme:cf:speicherbasiert:formel4} für eine Zahl im Bereich von null bis eins. Diese darf jedoch den Wert $\frac{1}{\lambda_1}$ nicht übersteigen darf. $\lambda_1$ entspricht dabei dem größten Eigenwert der untersuchten Matrix. \textcite{huang:2004} empfehlen, den Wert umso höher anzusetzen, je stärker transitive Beziehungen in der Berechnung gewichtet werden sollen.
