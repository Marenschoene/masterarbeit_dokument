...
Die von \textcite[S. 1]{semanticMatchmaking:2009} implementierte Recommener Engine wird auch als hybrides Empfehlungssystem bezeichnet. Solche Systeme kombinieren mehrere Vorschlagsverfahren innerhalb einer Anwendung.

\section{Hybride Empfehlungssysteme}
\label{ch:empfehlungssysteme:hybrideEmpfehlungssysteme}


imvorgeschlagen, mehrere Implementierungsansätze von Recommender Engines kombiniert, spricht die Literatur von hybriden Empfehlungssystemen.
