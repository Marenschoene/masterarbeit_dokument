...
Modellbasierte Verfahren verwenden Ansätze aus den Bereichen des Data Minings und des maschinellen Lernens zur Generierung von Vorschlägen. Hierbei berechnen Wissenschaftler statistische Modelle, bevor sie ihr Empfehlungssystem den Nutzern zur Verfügung stellen. Dieses Vorgehen hat den Vorteil, dass in der Produktivumgebung eingesetzte Recommender Eninges auch bei großen Datenmengen wesentlich effizienter Vorschläge bestimmen können als es bei speicherbasierten Verfahren möglich ist \cite[S. 8]{yang:2016}.

Bei modellbasierten Verfahren ist es üblich,
