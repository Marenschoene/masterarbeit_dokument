...
\begin{table}[h]
	...
	\begin{tabular}{c|c|c|c|c|c|c|c|c|c|c}
		...
		Erika M. & 0 & 0 & 0 & 0 & 0 & 0 & 0 & 0 & 5 & 3\\%5 auf 2
...
Beim inhaltsbasierten Filtern werden die Daten anderer Anwender bei der Bestimmung von Vorhersagen nicht genutzt. Algorithmen in diesem Bereich fokussieren dafür Beschreibungen und Eigenschaften eines Zielnutzers und der Elemente in der Datenbank \cite[S. 139f.]{recommenderSystems:2016}.

In Bezug auf Job-Empfehlungssysteme ist eine in der Literatur verbreitete Vorgehensweise, über Methoden aus der Computerlinguistik aus unstrukturierten Stellenausschreibungen und Lebensläufen semantische Merkmale zu extrahieren. Dabei werden über Ähnlichkeitsberechnungen zwischen den Merkmalsmodellen Empfehlungen generiert. Beispielsweise entwickelten \textcite[S. 4ff.]{guo:2016} ein solches System für Bewerber zur Stellensuche. \textcite[S. 3ff.]{prospect:2010} implementierten eine vergleichbare Anwendung für Unternehmen, um passende Bewerber bei der Stellenbesetzung auszuwählen.
