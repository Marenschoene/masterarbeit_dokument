...
Exemplarisch wird im folgenden Teil das Lernen eines Modells auf Basis eines Entscheidungsbaumes demonstriert. Zur Vereinfachung der Berechnung werden die Spalten aus Tabelle \ref{tbl:empfehlungssysteme:arbeitsweise:tbl1} reduziert und die Bewertungen auf boolsche Werte geändert. Tabelle \ref{tbl:empfehlungssysteme:cf:modellbasiert:tbl1} enthält die vereinfachten Daten.
...
\begin{table}[h]
	...
	\begin{tabular}{c|c|c}
		...
		Muster, Max & 1 & 1
	\end{tabular}
	\caption{Beispiel für die Matrixdarstellung von Fähigkeiten mit boolschen Bewertungen}
