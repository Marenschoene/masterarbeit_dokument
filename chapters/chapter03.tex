...
\textcite[S. 7ff.]{huang:2004} bemerken mit Blick auf Darstellungen wie Abbildung \ref{fig:empfehlungssysteme:cf:speicherbasiert:abb2}, dass bei nachbarschaftsbasierten Ansätzen nur Empfehlungen für Knoten bestimmt werden können, welche vom Zielknoten über drei Kanten zu erreichen sind. Im vorliegenden Beispiel ist zu erkennen, dass über solche Verfahren somit keine Bewertungs-Vorhersage für Jane Doe und Spark bzw. Erika Muster und MongoDB bestimmt werden können. Den Wissenschaftlern zu Folge eignet sich in einem solchen Fall der Einsatz graphenbasierter Algorithmen. Diese beachten auch transitive Verbindungen zwischen Knoten und beziehen diese in die Berechnung mit ein.

Ihr Verfahren sieht es vor, die Gewichte aller unabhängigen Wege zwischen dem Zielknoten und allen anderen Knoten zu summieren.  
