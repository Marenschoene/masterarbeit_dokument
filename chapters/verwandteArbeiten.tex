...
\begin{figure}[h]
	\centering
	\includegraphics[width=0.25\textwidth]{gfx/faerber.png}
	\caption{Modell des hybriden Empfehlungssystems von \textcite[S. 8]{faerber:2003}}
	\label{fig:verwandteArbeiten:abb1}
\end{figure}

Präferenzen von Nutzern sind convexe Kombinationen unterliegender latenter Aspekte
- x ist Rekruiter mit Job-Beschreibung
- a sin die Attribute des Kandidaten
- y ist ein quadruple wie 

- CV-Recommender empfiehtlt CVs, welche ähnlich zu Lebensläufen sind, welche zuvor vom selben Recruiter für spezifische Job-Profile berücksichtigt wurden
