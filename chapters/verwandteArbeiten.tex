...
Bilaterale Empfehlungssysteme kombinieren die in Kapitel \ref{ch:personEnvironmentFit} betrachteten psychologischen Erkenntnisse zum Konzept des \acp{PEFit} mit denen in Kapitel xyz vorgestellten Implementierungsmethoden von Empfehlungssystemen (Quelle).

Bei der Durchsicht der Literatur ist festzustellen, dass bereits zahlreiche Publikationen den Anspruch verfolgten, ein System zur automatisierten Bestimmung des \acp{PJFit} zu entwickeln. Jedoch beziehen sich einige Forscher dabei nicht auf das entsprechende Konzept der Psychologie. Die Bestimmung der Kongruenz findet dabei ausschließlich auf der Ebene des Anforderungen-Fähigkeiten Fits statt. Dieser Sachverhalt ist beispielsweise in der Veröffentlichung von \textcite[S. 1ff.]{personJobFit:2018} und \textcite[S. 1ff.]{qin:2018} zu beobachten. \textcite[S. 1, Z. 1f.]{personJobFit:2018} definierten den \ac{PJFit} als den "Prozess des Zusammenführens des richtigen Talents für die richtige Stelle durch die Identifizierung von Talentkompetenzen, welche für die Stelle erforderlich sind."\footnote{"process of matching the right talent for the right job by identifying talent competencies that are required for the job." - \textcite[S. 1, Z. 1f.]{personJobFit:2018}} Dementsprechend stellten die Wissenschaftler in ihrer Publikation ein System vor, welches über modellbasierte Verfahren aus unstrukturierten Bewerbungen lernte, ob eine Person aufgrund ihrer Fähigkeiten für die Anforderungen einer Stelle geeignet ist \cite[S. 1ff.]{personJobFit:2018}. Ein ähnliches System zum \ac{PJFit} entwickelten auch \textcite[S. 1ff.]{qin:2018}. Auch deren Anwendung bereitete Stellenausschreibungen und Lebensläufe strukturiert auf. Aus diesen Daten sagten die Wissenschaftler über ein neuronales Netz voraus, ob die Bewerbung eines Kandidaten für eine Stelle erfolgreich sein würde. 




In beiden Fällen untersuchten die Forscher ausschließlich die Übereinstimmung zwischen gesuchten und vorhandenen Fähigkeiten in Stellenausschreibungen und Lebensläufen.

Zwei Empfehlungssysteme, welche sowohl den Anforderungen-Fähigkeiten Fit als auch den Bedürfnisse-Angebote Fit betrachten, wurden am .. Frankfurt
