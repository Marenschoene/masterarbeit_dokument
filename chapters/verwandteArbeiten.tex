...
- Angenommen es gibt die drei Nutzer A, B und C und diese haben sich nicht explizit bewertet, haben aber eine Ähnliche Präferenzstruktur, was die Bewertungen angeht --> DiesePräferenzstrukturen werden genutzt, um einen Ähnlichkeitsbasierte Trust-Werte zu bestimmen
...
\newpage
Die Idee des bilateralen Empfehlungssystems basiert auf dem Konzept des Person-Job Fits aus der Organisationspsychologie \cite[S. 3]{malinowski:2006}. In diesem Fachgebiet untersuchten verschiedene Wissenschaftler, unter welchen Bedingungen eine Person aus psychologischer Sicht für eine Stelle geeignet ist. Dabei stellten sie fest, dass neben der Befähigung des Mitarbeiters auch dessen Wünsche bzw. Bedürfnisse zur vorgesehenen Stelle passen müssen \cite[S. 2ff.]{edwards:1991}. Aus diesem Grund sollten beide Faktoren laut \textcite[S. 1]{malinowski:2006} auch von Recommender Systems berücksichtigt werden. Betrachtet eine IT-Anwendung neben den Anforderungen an die Fähigkeiten des Mitarbeiters auch dessen Wünsche, sprechen die Wissenschaftler von einem bilateralen Empfehlungssystem.\\
Zu diesen Systemen ist zu bemerken, dass die Wünsche des Mitarbeiters in der Literatur nicht einheitlich interpretiert werden. So entwickelten \textcite[S. 1ff.]{applyingDataMining:2014} ein bilaterales Empfehlungssystem auf Basis von Data Mining-Technologien. Sie verstanden dabei unter den Wünschen des Nutzers dessen Präferenzen für ein bestimmtes Gehalt oder die Bekanntheit eines potenziellen Arbeitgebers. \textcite[S. 4ff.]{malinowski:2006} interpretierten die Wünsche des Nutzers dagegen als dessen Präferenz für bestimmte Stellenprofile.\\
