...
Anhand einer Befragung unter den Mitarbeitern des IT-Unternehmens Exxeta AG wurden Fähigkeiten und Präferenzen von Mitarbeitern sowie deren Zufriedenheit mit ausgewählten Beispielprojekten ermittelt.
...
Analog wird hinsichtlich der erwarteten Arbeitsleistung eines Mitarbeiters seitens der Entscheidungsträger angenommen, dass diese maßgeblich durch das Vorhandensein oder Fehlen bestimmter Fähigkeiten eines Mitarbeiters beeinflusst wird, unabhängig von dessen übrigen Fähigkeiten.
...
% Für die Konzeption eines solchen Systems stellt sich die Frage, wieviel der Entscheidung einem System und wieviel dem Entscheidungsträger bzw. den Entscheidungsträgern überlassen werden soll.
% In multi-kriteriellen Empfehlungssystemen muss daher geklärt werden, welche Kriterien unmittelbar in die Empfehlungserstellung einfliessen und hinsichtlich welcher Kriterien die Entscheidung an den Entscheidungsträger abgegeben werden sollen.
% Werden Empfehlungssysteme als Entscheidungsunterstützung eingesetzt, muss im Rahmen der Konzeption festgelegt werden, wie viel der Entscheidung an das System delegiert und wieviel von den Entscheidungsträgern mitbestimmt werden soll.
