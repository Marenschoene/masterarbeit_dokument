...
Die bilaterale Empfehlungskomponente bezieht die Wünsche der Mitarbeitern in Form von Wichtigkeiten in die Berechnung ein. Hierbei werden die präferierten Kompetenzen der Angestellten vor der Differenzberechnung mit \faktorString multipliziert. Dieser Wert wird in Anlehnung an die Gewichte der Niveaus Grundkenntnisse von \kantengewicht und Fortgeschritten von \kantengewichtHoch, welche ebenfalls einer Verdopplung entsprechen gewählt. Diese Multiplikation hat zur Folge, dass Mitarbeiter für eine gesuchte Kompetenz innerhalb ihres beherrschten Niveaus aufsteigen oder die untere Grenze des nächst höheren Bereichs erreichen. Durch dieses Vorgehen befinden sich die Angestellten nach wie vor nahe ihres ursprünglichen Kompetenzbereichs, werden bei der Sortierung jedoch besser 

Wie in Kapitel \ref{ch:personEnvironmentFit:regressionsgleichungen} gefordert, werden auf diese Weise die Wichtigkeiten ausschließlich für den betrachteten Kompetenzwert der Person einbezogen.
