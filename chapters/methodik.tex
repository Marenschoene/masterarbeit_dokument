...
Dem im Rahmen dieser Master-Thesis implementieren Empfehlungssystem liegt eine Microservice-Architektur zu Grunde, welche aus drei Diensten besteht. Abbildung \ref{fig:methodik:systemarchitekturn:abb1} zeigt einen Überblick über die Systemarchitektur der Anwendung.
...
\begin{table}[h]
	...
	\begin{tabular}{c|c|c|c|c|c|c|c}
		...
		\hline
		Jane D. & \cellcolor{usercolor}Falsch & \cellcolor{usercolor}Falsch & \cellcolor{usercolor}Falsch & \cellcolor{usercolor}Falsch & \cellcolor{itemcolor}Wahr & \cellcolor{usercolor}Falsch & \cellcolor{itemcolor}Wahr\\
		John D. & \cellcolor{usercolor}Falsch & \cellcolor{itemcolor}Wahr & \cellcolor{itemcolor}Wahr & \cellcolor{usercolor}Falsch & \cellcolor{itemcolor}Wahr & \cellcolor{usercolor}Falsch & \cellcolor{usercolor}Falsch\\
		Erika M. & \cellcolor{usercolor}Falsch & \cellcolor{itemcolor}Wahr & \cellcolor{usercolor}Falsch & \cellcolor{usercolor}Falsch & \cellcolor{usercolor}Falsch & \cellcolor{usercolor}Falsch & \cellcolor{usercolor}Falsch\\
		Max M. & \cellcolor{usercolor}Falsch & \cellcolor{usercolor}Falsch & \cellcolor{itemcolor}Wahr & \cellcolor{usercolor}Falsch & \cellcolor{itemcolor}Wahr & \cellcolor{usercolor}Falsch & \cellcolor{usercolor}Falsch
	\end{tabular}
	\caption{Beispiel für die Präferenzangaben von Mitarbeitern mit boolschen Werten (w/f)}
...
In der vorliegenden Problemstellung werden nicht die Daten aller Angestellten des Unternehmens benötigt. Der Empfehlungsalgorithmus benötigt ausschließlich die Informationen von denjenigen Mitarbeitern, welche im Rahmen der Umfrage Präferenzen bezüglich eingesetzter Kompetenzen spezifiziert haben.

Die Aufgabe des Intranetservices besteht darin, die Rückgabe der Schnittstelle des Intranets der EXXETA AG mit den erhobenen Präferenzen der Umfrage zu kombinieren und sämtliche nicht benötigten Informationen zu Gunsten der Datensparsamkeit zu entfernen. Listing \ref{qc:methodik:versuchsaufbau:daten:qc1} zeigt einen beispielhaften Auszug aus der Rückgabe des Intranetservices.
