...
Die Kompetenzbewertungen der Mitarbeiter und deren Präferenzen dienen im Experiment als Datengrundlage für ein hybrides Empfehlungssystem.
...
In Listing \ref{qc:methodik:versuchsaufbau:daten:qc1} ist zu erkennen, dass die ganzzahligen Kompetenz-Bewertungen des tatsächlichen Intranets um eins erhöht werden. Somit reichen die Beurteilungen beherrschter Fähigkeiten anstelle von 0 bis fünf nun von eins bis sechs. Auf diese Weise verfügen ausschließlich nicht beherrschte Kompetenzen über eine Bewertung von 0.

Die Implementierung des Intranetservices erfolgte in der Programmiersprache Kotlin. Als Framework wurde Spring Boot in Kombination mit dem GraalVM Native Image-Compiler verwendet, welcher die Startzeit und den Speicherverbrauch des Dienstes stark reduziert.
...
Im Intranet der EXXETA AG ist zu beobachten, dass einige Mitarbeiter keine einzige Fähigkeit bewertet haben. Hierbei handelt es sich beispielsweise um neue Angestellte, Werkstudenten oder Personen in Zentralfunktionen wie Buchhaltung und Marketing. Es ist außerdem zu erwarten, dass spezialisierte Mitarbeiter ausschließlich Kompetenzen bewerten, über welche kein anderer Angestellter verfügt. Liegen derartige Sachverhalte vor, sind die jeweiligen Mitarbeiter im Graphen mit keinem anderen Angestellten über Kanten verbunden. Es folgt ein Kaltstart bei der Empfehlungsbestimmung.
...
Zur unilateralen Empfehlungsbestimmung werden die Ergebnisse der Matrixberechnung ohne weitere Veränderung genutzt. Um bilaterale Vorschläge zu bestimmen, bezieht der Matrixservice zusätzlich die Präferenzen der Angestellten ein. Hierbei wird angenommen, dass Projektmanager stets denjenigen Mitarbeiter für eine benötigte Kompetenz auswählen, welcher für das gesuchte Kompetenzniveau (Grundkenntnisse bzw. Fortgeschritten) die höchste Bewertung aufweist. Aus diesem Grund wird die sechsstufige Skala des Intranets nach der Ausführung des Katz-Algorithmus auf die in Tabelle \ref{tbl:methodik:versuchsaufbau:systemarchitektur:matrixservice:tbl1} dargestellten Kompetenzniveaus vereinfacht. 
