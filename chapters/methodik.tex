...
Die Implementierung des Matrixservices erfolgte in der Programmiersprache Python. Eingesetzt werden zusätzlich das Framework Flask und das Paket Numpy, welches die Matrixberechnungen unterstützt. Als Pufferspeicher kommt der Schlüssel-Wert-Speicher Redis zum Einsatz.

Die finale Bestimmung der uni- und bilateralen Empfehlungen anhand der Ausgabe des Matrixservices erfolgt abschließend im Empfehlungsservice.
