...
Die Projektmanager erhalten die sortierten Mitarbeiter beider Empfehlungsansätze für die vorausgewählten Projektpositionen in Form von Listen. Hierbei können sie nicht erkennen, welche Vorschläge über den uni- und welche über den bilateralen Ansatz erzeugt wurden. Anschließend bewerten sie auf einer vordefinierten Skala, welche Arbeitsleistung sie von denen in der vorliegenden Reihenfolge dargestellten Mitarbeitern für die jeweiligen Stellen erwarten. Dabei wird evaluiert, ob sie die erwartete Leistung der vorgeschlagenen Angestellten des bilateralen Ansatzes höher bewerten, als die der unilateralen Variante.
...
\begin{figure}[h]
	\centering
	\includegraphics[width=0.8\textwidth]{gfx/ArchitekturMitLinie.jpg}
...
In der Umfrage, in welcher die Mitarbeiter gebeten werden, ihre präferierten Kompetenzen auszuwählen, erhalten diese zusätzlich die definierten Stellen aus Abbildung \ref{fig:methodik:evaluation:abb2}. Hierbei werden diese aufgefordert, ihre Zufriedenheit einer Tätigkeit auf den dargestellten Projektpositionen auf einer vierstufigen Skala zu bewerten. Diese wird gewählt, um neutrale Beurteilungen zu vermeiden. Abbildung \ref{fig:methodik:evaluation:abb1} zeigt einen Auszug aus der Umfrage, welchem die Aufgabenstellung zu entnehmen ist.
...
Im Anschluss an die Umfrage wird evaluiert, ob die Projektmanager die erwartete Leistung der vorgeschlagenen Angestellten des bilateralen Ansatzes höher bewerten, als die der unilateralen Variante.
\shorthandon{"}