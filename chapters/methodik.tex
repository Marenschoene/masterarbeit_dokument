...
Die EXXETA AG erhebt keine Präferenzen ihrer Mitarbeiter bezüglich deren Kompetenzen. Um diese Vorlieben ebenfalls in die Empfehlungsprozess einzubeziehen, werden diese im Rahmen dieser Thesis über eine Umfrage erhoben. Die Angestellten des Bereichs \ac{JES} erhalten zu diesem Zweck einen Fragebogen mit den 551 Fähigkeiten des Intranets. Dabei werden sie gebeten, sämtliche Kompetenzen auszuwählen, welche sie gerne im Projekt anwenden möchten. Ein Auszug aus dem Fragebogen ist in Abbildung \ref{fig:methodik:versuchsaufbau:abb1} dargestellt.
...
Die Kompetenzbewertungen der Mitarbeiter und deren Präferenzen dienen im Experiment als Grundlage für das Empfehlungssystem, welches primär auf der Datenstruktur eines Graphen basiert.

\section{Verwendete Datenstruktur}
\label{ch:methodik:datenstruktur}
Die Mitarbeiter der EXXETA AG und deren Fähigkeiten werden in der Datenstruktur eines Graphen dargestellt. Um das Sparsity Problem zu lösen, wird der speicherbasierte Algorithmus von Katz aus Kapitel \ref{ch:empfehlungssysteme:cf:speicherbasiert} angewendet. Da die Anwendung auch über die Master-Thesis hinaus im Unternehmen zum Einsatz kommen soll, ist insbesondere die Langlebigkeit des Verfahrens vorteilhaft gegenüber modellbasierten Methoden. Sollten sich nach Durchführung des Experiments Daten im Unternehmen verändern oder neue Kompetenzen im Intranet hinzugefügt werden, ist der speicherbasierte Algorithmus weiterhin ohne zusätzlichen manuellen Aufwand im Betrieb anwendbar. Die hohe Komplexität ist in der vorliegenden Problemstellung tolerierbar, da sich zum Zeitpunkt des Experiments weniger als 1.000 Mitarbeiter im Unternehmen befinden.
