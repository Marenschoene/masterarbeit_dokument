...
Die Ergebnisse der Matrixberechnung dienen als Grundlage für die Empfehlungsbestimmung. Es wird angenommen, dass Projektmanager stets denjenigen Mitarbeiter für eine bestimmte Kompetenz auswählen, welcher für das gesuchte Niveau  Grundkenntnisse bzw. Fortgeschritten die höchste Bewertung aufweist. Aus diesem Grund wird die sechsstufige Skala des Intranets auf die in Tabelle \ref{tbl:methodik:versuchsaufbau:systemarchitektur:matrixservice:tbl1} dargestellten Kompetenzniveaus vereinfacht. 
