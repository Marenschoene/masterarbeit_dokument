...
Um Rechenleistung einzusparen, werden die Teams nicht als zusätzliche Knoten in den Graphen eingefügt. Die Beziehungen werden stattdessen über direkte Kanten zwischen Kollegen dargestellt. Das Kantengewicht zwischen zwei Teammitgliedern bzw. einem Angestellten zu seinem Manager beträgt eins. Über diesen Ansatz sind alle Teammitglieder schwach miteinander verbunden, sodass die vorhandenen Bewertungen wenig verzerrt werden und dennoch auch im Fall eines Kaltstarts für Mitarbeiter ohne explizite Bewertungen aussagekräftige Beurteilungen bestimmt werden können.
...
\begin{figure}[h]
	...
	\begin{tikzpicture}[node distance={32mm}, thick, main/.style = {draw, circle}] 
		...
		\draw (Jane) -- node[midway, above] {1} (John);
		\draw (Jane) -- node[midway, left] {1} (Max);
		\path (Jane) edge[bend left=25] node[midway, above] {1} (Erika);
...
\begin{table}[h]
	...
	\begin{tabular}{c|c|c|c|c|c|c|c|c|c|c|c}
		...
		\hline
		Jane D.  & 3.0 & 1.6 & 1.7 & 2.1 & 2.1 & 0.9 & 3.1 & 1.7 & 1.8 & 1.0 & 1.1\\
		John D.  & 1.6 & 0.9 & 1.0 & 1.2 & 1.0 & 0.8 & 1.4 & 1.0 & 0.8 & 0.7 & 0.6\\
		Erika M. & 1.7 & 1.0 & 1.4 & 1.2 & 1.2 & 0.6 & 1.5 & 0.8 & 0.9 & 1.3 & 1.1\\
		Max M.   & 2.1 & 1.2 & 1.2 & 1.4 & 1.4 & 0.8 & 2.1 & 1.1 & 1.0 & 0.7 & 0.8\\
		Projekt  & 2.1 & 1.0 & 1.2 & 1.4 & 1.7 & 0.6 & 2.4 & 1.0 & 1.5 & 0.7 & 1.2\\
		Java     & 0.9 & 0.8 & 0.6 & 0.8 & 0.6 & 0.4 & 0.8 & 0.5 & 0.4 & 0.4 & 0.3\\
		Python   & 3.1 & 1.4 & 1.5 & 2.1 & 2.4 & 0.8 & 2.8 & 1.4 & 1.6 & 0.9 & 1.2\\
		MySQL    & 1.7 & 1.0 & 0.8 & 1.1 & 1.0 & 0.5 & 1.4 & 0.8 & 0.8 & 0.5 & 0.5\\
		MongoDB  & 1.8 & 0.8 & 0.9 & 1.0 & 1.5 & 0.4 & 1.6 & 0.8 & 1.0 & 0.5 & 0.7\\
		HDFS     & 1.0 & 0.7 & 1.3 & 0.7 & 0.7 & 0.4 & 0.9 & 0.5 & 0.5 & 0.7 & 0.6\\
		Spark    & 1.1 & 0.6 & 1.1 & 0.8 & 1.2 & 0.3 & 1.2 & 0.5 & 0.7 & 0.6 & 0.7
	\end{tabular}
