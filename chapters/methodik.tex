...
Die in Tabelle \ref{tbl:methodik:versuchsaufbau:unilateral:tbl1} dargestellten Ergebnisse der Matrixberechnung werden in der weiteren Berechnung ohne weitere Veränderung für die unilaterale Empfehlungsbestimmung genutzt. Um bilaterale Vorschläge zu bestimmen, betrachtet der Matrixservice zusätzlich die Präferenzen der Angestellten. Es wird angenommen, dass Projektmanager stets denjenigen Mitarbeiter für eine benötigte Kompetenz auswählen, welcher für das gesuchte Kompetenzniveau (Grundkenntnisse bzw. Fortgeschritten) die höchste Bewertung aufweist. Aus diesem Grund wird die sechsstufige Skala des Intranets nach der Ausführung des Katz-Algorithmus auf die in Tabelle \ref{tbl:methodik:versuchsaufbau:systemarchitektur:matrixservice:tbl1} dargestellten Kompetenzniveaus vereinfacht. 
