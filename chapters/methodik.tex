...
Um die Forschungsfrage dieser Master-Thesis zu beantworten, wird eine quantitative Forschungsarbeit in Form eines Experiments durchgeführt. In diesem Kontext werden zwei Schnittstellen eines Empfehlungssystems zur Besetzung offener Projektpositionen implementiert. Einer der beiden Endpunkte verfolgt einen unilateralen, der andere einen bilateralen Ansatz. Beide Empfehlungsverfahren erhalten dieselben offenen Projektpositionen und Mitarbeiter als Eingabe. Anschließend sortieren sie die vorhandenen Angestellten für die offenen Stellen und geben diese in Form von Listen zurück.

Die Ausgaben beider Schnittstellen werden Projektmanagern vorgelegt. Diese bewerten für jede Liste auf einer vordefinierten Skala, welche Arbeitsleistung sie von denen in der vorliegenden Reihenfolge dargestellten Mitarbeitern erwarten. Dabei wird evaluiert, ob sie die erwartete Leistung der vorgeschlagenen Angestellten des bilateralen Verfahrens höher bewerten, als die der unilateralen Variante.
...
Die Kompetenzbewertungen der Mitarbeiter und die für ein Projekt benötigten Fähigkeiten dienen im Experiment als Eingabe für einen grundlegenden Algorithmus, welcher sowohl für das unilaterale, als auch das bilaterale Empfehlungssystem gleich ist.%das Empfehlungssystem, dessen Architektur aus zwei Diensten besteht.
