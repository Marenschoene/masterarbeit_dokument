...
Anhand der Daten aus Abbildung \ref{fig:methodik:versuchsaufbau:unilateral:abb1} folgt die Bestimmung der Katz-Zentralität. Die dabei entstehende Matrix dient als Eingabe für die unilaterale und die bilaterale Empfehlungs-Komponente. Beide Module unterscheiden sich, wie bei einem A/B-Test gefordert, ausschließlich in der Art, über welche sie die Ergebnisse des Katz-Algorithmus sortieren.
