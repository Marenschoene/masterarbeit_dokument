...
Die nach Berechnung des Katz-Algorithmus entstehende Matrix dient als Eingabe für die unilaterale und die bilaterale Empfehlungskomponente. Beide Module unterscheiden sich ausschließlich in der Art, wie sie die Mitarbeiter sortieren.

Zur effizienteren Vorschlagsbestimmung wird die Matrix zwischengespeichert. Somit muss die algorithmisch komplexe Berechnung des Katz-Algorithmus nur ausgeführt werden, wenn sich Daten im Unternehmen ändern. Wie bei speicherbasierten Verfahren üblich, können so immer die aktuellen Daten des Unternehmens betrachtet werden. Gleichzeitig wird eine zu modellbasierten Verfahren vergleichbare effiziente Berechnung der Empfehlungen erreicht.
