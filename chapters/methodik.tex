...
Die Mitarbeiter des Unternehmens und deren Fähigkeiten werden, wie in Abbildung \ref{fig:empfehlungssysteme:cf:speicherbasiert:abb2} dargestellt, in Form eines Graphen angeordnet. Zusätzlich wird das zu besetzende Projekt, wie in Kapitel \ref{ch:empfehlungssysteme:cf:speicherbasiert} im Kontext der Gruppen-Recommender Engines beschrieben, in Form eines Pseudo-Mitarbeiters in den Graphen eingefügt.
