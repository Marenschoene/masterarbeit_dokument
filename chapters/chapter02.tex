...
Der Person-Environment Fit \note{Eigenbegriffe sollten ggf. gekennzeichnet werden.} wird auch als P-E Fit \note{Für solche Abkürzungen bieten sich eigene Kommandos an um diese später zentral hinsichtlich Inhalt oder Darstellung ändern zu können.} abgekürzt \cite[S. 428]{dawis:2002} und findet sich in verschiedenen Publikationen ebenfalls unter ähnlichen Bezeichnungen mit derselben Bedeutung wie Match \cite[S. 2]{player:2017}, Korrespondenz \cite[S. 1]{eggerth:2008} oder Kongruenz \cite[S. 1]{muchinsky:1987}.
