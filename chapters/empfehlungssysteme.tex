...
So kann eine Empfehlung beispielsweise ein einziges Element umfassen (bspw. das Element mit dem größten angenommenen Nutzen für einen Nutzer) \cite[S. 6]{ricci:inbook}.
...
% Weglassen?
% Abbildung \ref{fig:empfehlungssysteme:recommendation:abb1} illustriert den zweistufigen Prozess der Empfehlungserstellung am Beispiel eines Ausschnitts der Mitarbeiter-Fähigkeiten Matrix aus Tabelle \ref{tab1}.
...
Präferenzen ermöglichen es, Empfehlungen für Nutzer zu personalisieren und sind daher für die individuelle Empfehlungserstellung in Empfehlungssystemen von großer Bedeutung.
% In diesem Kapitel werden sie daher allgemein erläutert und im Kontext von Empfehlungssystemen inhaltlich abgegrenzt.
...
Daher wird die Präferenz eines Nutzers $c$ für ein Element $s$ auch als dessen (angenommenes) Rating $R(c,s)$ verstanden.
Rating und Präferenz sind jedoch nicht zwangsläufig ein und dasselbe.
...
In Abhängigkeit des Grads der Personalisierung können Empfehlungen personalisierten bzw. nicht-personali\-sierten Empfehlungen zugeordnet werden \cite[S. 400]{unternährer:article}.
...
\begin{figure}[H]
    \centering
	\includegraphics[width=1.0\textwidth]{gfx/abbildung-präferenzen-A.png}
...
\begin{figure}[H]
    \centering
	\includegraphics[width=1.0\textwidth]{gfx/abbildung-präferenzen-B.png}
...
Diese können in \ac{I-2-P}- und \ac{P-2-P}-Empfehlungen unterschieden werden \cite[S. 62f.]{kim:inproceedings}.

In der Literatur wird unter traditioneller \ac{I-2-P}-Empfehlung die Empfehlung klassischer Inhalte (z.B. Bücher, Filme, Hotels) verstanden \cite[S. 2199]{akehurst:inproceedings}\cite[S. 2429]{palomares:inproceedings}.
In \ac{I-2-P}-Empfehlungen ist der Erfolg einer Empfehlung durch die Akzeptanz des Empfehlungsempfängers (d.h. des Nutzers) gekennzeichnet \cite[S. 131]{kleinerman:2:inproceedings}\cite[S. 546]{koprinska:inbook}.
% Für personalisierte \ac{I-2-P}-Empfehlungen verwenden Empfehlungssysteme Wissen über die Präferenzen der Nutzer, um ihnen potenziell interessante Elemente zu empfehlen \cite[S. 403]{terveen:article}.
...
Im Vergleich zu traditionellen Empfehlungssystemen basieren \ac{RRS} auf \ac{P-2-P}-Empfehlungen \cite[S. 207]{pizzato:2010}.
Unter \ac{P-2-P}-Empfehlung (auch: social matching \cite[S. 208]{pizzato:2010}) wird die Empfehlung von Personen an Nutzer eines Empfehlungssystems verstanden.
Im Gegensatz zu \ac{I-2-P}-Empfehlungen, handelt es sich bei den empfohlenen Elementen nicht um leblose Objekte, sondern um Menschen, die anderen Menschen empfohlen werden \cite[S. 2]{kazienko:inbook}.
...
Dies ist ein besonderer Aspekt, den es zu beachten gilt, da dadurch die Qualität der Empfehlungen beeinflusst werden kann \cite[S. 2199]{akehurst:inproceedings}\cite[S. 208]{pizzato:2010}.

Während ein Großteil der \ac{P-2-P}-Empfehlungen auf dem Aspekt der Reziprozität (engl.: reciprocity) beruhen \cite[S. 545]{koprinska:inbook}, ist nicht jede \ac{P-2-P}-Empfehlung unmittelbar reziprok.
Empfehlungen können auch \ac{P-2-P}-Empfehlungen sein und lediglich die Präferenzen der Empfehlungsempfänger berücksichtigen \cite[S. 2429]{palomares:inproceedings}.
Ein Beispiel stellen \ac{P-2-P}-Empfehlungen des sozialen Netzwerks Twitter dar \cite[S. 2429]{palomares:inproceedings}.
...
Bei Empfehlungen in \ac{RRS} handelt es sich um reziproke \ac{P-2-P}-Empfehlungen \cite[S. 207]{pizzato:2010}, deren Erfolg von der Berücksichtigung der bilateralen Präferenzen abhängt.
...
Soll dem Nutzer $X$ das Element empfohlen werden, welches seine Bedürfnisse am stärksten erfüllt, würde nach dem traditionellen System eindeutig Element $C$ ausgewählt werden.
...
Daraus wird ersichtlich, dass Person $C$ die Präferenzen des Nutzers $X$ erfüllt, aber eine Empfehlung von Person $C$ für Nutzer $X$ nicht die Präferenzen von Person $C$ erfüllen würde.
...
Das "Stable-Marriage"-Problem beschreibt das Problem der Bestimmung einer optimalen Paarung (engl.: Match) zweier Mengen an Elementen anhand ihrer Präferenzen, sodass kein Element durch Paarung mit einem anderen Partner besser gestellt wäre \cite[S. 67]{diaz:inproceedings}\cite[S. 36]{li:inproceedings}.
...
Die Erfüllung der Präferenzen einer Person durch eine Andere bezeichnet \textcite[S. 2429]{palomares:inproceedings} als Präferenzwert.
Die unabhängig voneinander ermittelten Präferenzwerte werden dann mittels Aggregation zu einem bilateralen Präferenzwert zusammengeführt, welche den angenommenen Wert der beidseitigen Präferenzerfüllung angibt.
