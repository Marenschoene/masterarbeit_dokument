...
\subsection{Zugrundeliegende Datenstruktur}% Frage ist, wie Präferenzen in RS aussehen
...
\begin{figure}[H]
    ...
    \subfloat[Nutzer$_{Attribut}\times$Element$_{Attribut}\times$Kontext$_{Attribut}$ - Matrix]{\includegraphics[height=1.7in]{gfx/abbildung-präferenzen-C.png}\label{fig:empfehlungssysteme:preferences:abb1:3}}
...
% In Anlehnung an \textcite[S. 250ff]{berkovsky:article} und \textcite[S. 198]{ricci:book} kann für die Abbildung der zugehörigen Nutzermodelle Liste an Tripeln angenommen werden:
