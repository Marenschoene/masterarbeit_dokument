...
Durch die Verknüpfung mehrerer unterschiedlicher Empfehlungsansätze ist es mittels hybrider Systeme möglich, die Vorteile mehrerer Ansätze miteinander verbinden. Auf diese Weise kann die Qualität der Ergebnisse weiter verbessert werden \cite[S. 199ff.]{recommenderSystems:2016}\cite[S. 8]{malinowski:2008}.
