...
% HIER ERWÄHNEN DASS ERSTMAL AUCH RATING GENOMMEN WIRD!
...
In der Vorhersage-Phase werden für alle Nutzer-Element-Kombinationen, für die keine Transaktionen vorliegen, deren Nutzer-Element-Interaktion vorhergesagt.
...
Aufgabe eines Empfehlungssystems ist es daher die fehlenden Werte für Nutzer- Element- Kombinationen der Rating-Matrix $R$ vorherzusagen.
...
Zu klassischen Inhalten von Empfehlungen zählt \textcite[S. 2429]{palomares:inproceedings} unter anderem Musik, Filme, Konsumgüter, Hotels und Restaurants. 
Empfehlungssysteme, in denen die Inhalte von Empfehlungen gleichzeitig die Nutzer eines Systems bilden (bspw. in Online-Dating-Plattformen oder Recruiting-Systemen), werden in der Literatur als wechselseitige Empfehlungssysteme (engl.: \ac{RRS}) bezeichnet \cite[S. 207]{pizzato:2010}\cite[S. 2199]{akehurst:inproceedings}.
Nachfolgend soll das Konzept der RRS und dessen zugrundeliegende Problemstellung erläutert werden.

%Im vorangegangenen Kapitel wurde der Begriff der Präferenzen als Vorlieben und Verhaltensweisen von Nutzern in Empfehlungssystemen definiert.
...
In der Literatur wird unter traditioneller I2P-Empfehlung die Empfehlung klassischer Inhalte (z.B. Bücher, Filme, Restaurants) verstanden \cite[S. 2199]{akehurst:inproceedings}\cite[S. 2429]{palomares:inproceedings}.
In I2P-Empfehlungen ist der Erfolg einer Empfehlung durch die Akzeptanz des Empfehlungsempfängers (Nutzer) gekennzeichnet \cite[S. 131]{kleinerman:2:inproceedings}\cite[S. 546]{koprinska:inbook}.
...
Ein Großteil der P2P-Empfehlungen beruhen auf dem Aspekt der Reziprozität (engl.: reciprocity (dt.: Gegenseitigkeit)) \cite[S. 545]{koprinska:inbook}.
Das bedeutet, dass für eine erfolgreiche Empfehlung sowohl die Präferenzen des Empfängers einer Empfehlung, als auch die Präferenzen der empfohlenen Person berücksichtigt werden \cite[S. 447]{pizzato:2013}\cite[S. 22]{kleinerman:inproceedings}.
Der Erfolg einer Empfehlung hängt folglich von bilateralen Präferenzen ab, nicht wie in traditionellen Systemen lediglich von den Präferenzen der Nutzer \cite[S. 1468]{yildirim:article}.
...
Nicht jede P2P-Empfehlung ist unmittelbar reziprok.
...
Dieser Zusammenhang ist nachfolgend in Abbildung \ref{fig:empfehlungssysteme:rrs:abb1} dargestellt.
Ein roter Pfeil von einer Person zu einer anderen stellt hierbei die Präferenz einer Person für eine andere dar.
% Hier erklären, dass das bedeutet, dass eine person den präferenzen entpsricht (bspw. aufgrund von angaben im nutzerprofil)
major challenge: how to satisfy the needs of both users in a rec % S. 35, file://wsl%24/Ubuntu/home/masc6/Projects/masterarbeit/literatur/MEET%20-%20A%20Generalized%20Framework.pdf
stable marriage problem % file://wsl%24/Ubuntu/home/masc6/Projects/masterarbeit/literatur/MEET%20-%20A%20Generalized%20Framework.pdf
