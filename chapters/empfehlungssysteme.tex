...
In den meisten Fällen geben Empfehlungssysteme eine sortierte Liste der nützlichsten Elemente zurück (umgangssprachlich: Top-$K$-Elemente), in der für jedes Element der angenommene Wert für einen Nutzer angegeben ist \cite[S. 6]{ricci:inbook}\cite[S. 3]{recommenderSystems:2016}\cite[S. 141]{ekstrand:article}.
Dabei gibt der Parameter $K$ die Anzahl an Elementen in der Liste an.
...
In der Literatur werden Elemente für Empfehlungen grundsätzlich anhand ihrer Nützlichkeit für einen Nutzer sortiert \cite[S. 735]{adomavicius:inproceedings}\cite[S. 10f.]{ricci:inbook}.
...
In der Praxis kann es vorkommen, dass von dem Rating nicht unmittelbar auf den tatsächlichen Nutzen einer Kombination für einen Nutzer geschlossen werden kann \cite[S. 896ff.]{adomavicius:article}.
...
Im Zusammenhang mit Empfehlungssystemen fällt häufig der Begriff der Präferenzen (engl.: preferences) \cite[S. 2]{ricci:inbook}\cite[S. 11f.]{recommenderSystems:2016}\cite[S. 87]{ekstrand:article}.
