...
\textcite[S. 705ff.]{kumari:article} setzen das von \textcite[S. 1467ff.]{yildirim:article} vorgestellte Modell als Benchmark für ihren Ansatzes zu \ac{RRS} in Online-Dating-Plattformen ein.
...
\begin{equation}\label{eq35}
    rcS(x,y) =
        \begin{cases}
            ...
            \frac{xy}{xy + (1-x) \times (1-y)} & \textnormal{sonst } \\
        \end{cases}
\end{equation}
...
% https://www.inf.unibz.it/~ricci/papers/p131-kleinerman.pdf
...
Die Autoren entwickelten daher eine Methode (sog. \ac{RWS}), die Empfehlungen wechselseitger Systeme basierend auf dem optimalen Gleichgewicht zwischen den Interessen zweier Personen erstellt.
\ac{RWS} kombiniert für jeden Nutzer die Wahrhscheinlichkeit, dass eine Person eine Empfehlung annimmt und die Wahrscheinlichkeit, dass die empfohlene Person dies positiv erwidert, zu einem einzelnen Wert kombiniert \cite[S. 131f.]{kleinerman:2:inproceedings}.
Im Vergleich zu herkömmlichen \ac{RRS}, in denen für alle Nutzer die Präferenzen beider Parteien gleichermaßen in den reziproken Wert einflossen, erfolgt die Gewichtung der Präferenzen nach der Methode von \textcite[S. 133]{kleinerman:2:inproceedings} für jeden Nutzer individuell, basierend auf dessen vergangenen Interaktionen.
% HIER BILD EINFÜGEN S: 134
% HIER WEITERMACHEN S: 133
...
% Wie einbringen, dass der Fokus vieler Arbeiten ein anderer ist? Das macht natürlich die Bewertung schwierig, da viel von mir angenommen wird (Fokus meist auf Vorhersage und nicht Kombination der Präferenzen)
