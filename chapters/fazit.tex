...
%Trotz der festgestellten Einschränkung konnte der im Rahmen dieser Arbeit implementierte bilaterale Empfehlungsansatz die gemessenen Ergebnisse für die Mehrheit der betrachteten Stellen sowohl auf Seiten der Mitarbeiter, als auch auf Seiten der Projektmanager optimieren. Die entsprechende Hypothese von \textcite{malinowski:2008} kann somit bestätigt werden. Die vorliegende Arbeit zeigt damit, dass die Erkenntnisse aus den psychologischen Forschungen des \acp{PEFit} auch auf die Implementierung von Empfehlungssystemen übertragen werden können. Diese Erkenntnis sollten zukünftige Arbeiten daher bei der Entwicklung von Vorschlagsverfahren im Bereich der Personalauswahl berücksichtigen und ihren Fokus von der getrennten Betrachtung von Person und Umgebung verstärkt auf das Zusammenspiel beider Komponenten richten. 
\newpage
