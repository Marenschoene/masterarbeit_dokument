...
\textcite[S. 6f.]{edwards:2007} unterschieden drei Ebenen, auf welchen ein Fit bestimmbar ist. Die Oberste bezeichneten sie als globale Ebene. Hier werden Person und Umgebung meist als Ganzes ohne weitere Untergliederungen miteinander vergleichen. Wird eine Einteilung in mehrere sehr breite Bereiche vorgenommen, sprachen \textcite[S. 7f.]{edwards:2007} von der Domänen-Ebene. Hier können beispielsweise Werte, Persönlichkeiten und Ziele von Person und Umgebung miteinander verglichen werden. Findet die Untersuchung ausschließlich innerhalb einer Domäne statt, bezeichneten \textcite[S. 7f.]{edwards:2007} dies als Facetten-Ebene. Als Beispiel nannten die Wissenschaftler die Bestimmung eines \acp{PEFit} hinsichtlich demographischer Ähnlichkeit anhand von Dimensionen wie Alter und Bildung.
